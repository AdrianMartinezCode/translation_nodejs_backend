...
const creationService = require("../../src/services/sentences.service")({ db, translator: null }).create;

const Path = require('path');

const filePath = Path.join(__dirname, "..", "..", "resources", "sentences.jsonl.txt");

const fs = require('fs');
const readline = require('readline');


const getCategory = ({ responsibility, benefit, none, education, experience, soft, tech }) => {
